...
/bin/bash $HOME/assembly_illumina/assembly_illumina.sh  -1 $input1 -2 $input2 -o $outputdir -s $samplename --metagenemark --assembly -n $3 &> $outputdir/log_assembly_illumina.txt 
   """ >"${PBS_SCRIPT}_${a}.sh"
